...
// FUNCTION SIGNATURE Modified by RSDG
typedef cass_dist_t (*cass_vecset_dist_func_t) (cass_dataset_t *, cass_vecset_id_t,
		cass_dataset_t *, cass_vecset_id_t , cass_vec_dist_t *vec_dist, void *, int);
...
typedef int cass_table_query_t(cass_table_t *table, 
	cass_query_t *query, cass_result_t *result, int testNum);
